...
from config import (
    ...
    OO05_DEFAULT_ODDS_HOME,
    OO05_DEFAULT_ODDS_AWAY,
    ...
    OO05_OVERALL_STREAK_12,
    OO05_VENUE_STREAK_6,
    OO05_VENUE_STREAK_5,

    # OO.5 defence gates (opponent conceding) — HARD VETO
    OO05_OPP_VENUE_LEAK_5,
    OO05_OPP_OVERALL_LEAK_10,
    OO05_OPP_VENUE_ELITE_5,
    OO05_OPP_OVERALL_ELITE_10,

    # OO.5 weak ROI
    OO05_WEAK_ROI_KEYWORDS,
    OO05_WEAK_ROI_MULTIPLIER,
