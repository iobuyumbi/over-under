...
def main(date_str=None, only_scheduled=False):
    ...
    if perfect:
        for i, p in enumerate(perfect, 1):
            ...
            print(f"   Home form (last 3): {p['home_form']}")
            print(f"   Home form (last 6): {p['home_form_6']}")
            print(f"   Away form (last 3): {p['away_form']}")
            print(f"   Away form (last 6): {p['away_form_6']}")
    ...
    if qualified:
        for i, q in enumerate(qualified, 1):
            ...
            if m['score']:
                print(f"   Score: {m['score']}")
            print(f"   Home form (last 3): {q['home_form']}")
            print(f"   Home form (last 6): {q['home_form_6']}")
            print(f"   Away form (last 3): {q['away_form']}")
            print(f"   Away form (last 6): {q['away_form_6']}")
    ...
    if close_calls:
        for c in close_calls:
            ...
            print(f"  Home form (last 3): {c['home_form']}")
            print(f"  Home form (last 6): {c['home_form_6']}")
            print(f"  Away form (last 3): {c['away_form']}")
            print(f"  Away form (last 6): {c['away_form_6']}")
